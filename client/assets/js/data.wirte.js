    ...
    fetch('https://writting.herokuapp.com/api/v1/categories')
        ...
        .then(function(categories) {
            ...
            selectCategories(function() {
                ...
                console.log(`https://writting.herokuapp.com/api/v1/category/${arrCategId.toString()}/post`);
                var submitBtn = document.querySelector(".content-confirm_btn");
                submitBtn.addEventListener("click", function() {
                    fetch(`https://writting.herokuapp.com/api/v1/category/${arrCategId.toString()}/post`, requestOptions)
...
function getContentOldPost(id) {
    ...
    if (id !== null) {
        ...
        // console.log(content);
        fetch(`https://writting.herokuapp.com/api/v1/post/${id}`)
        .then(response => {
            return response.json();
        })
        .then(result => {
...
function publishOldPost(title, description, content, id) {
    ...
    document.querySelector(".content-confirm_btn").addEventListener("click", function() {
        fetch(`https://writting.herokuapp.com/api/v1/post/${id}`, requestOptions)
        .then(response => response.text())
        .then(result => {
